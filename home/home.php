<html>
    ...
    <head>
        <body>
          ...
          <h3><b>List Menu Toko Steak Amad</b></h3>
            ...
            $datasteak = [
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      ...
                      <a href="../transaksi/transaksi.php?id=<?=$tampil?>" class="btn btn-outline-dark btn-light">Pilih Untuk Transaksi</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- <div class="col-lg-3 col-sm-12">
                <div class="card title">
                  ...
                  <p class="card-text"><?=$data[1]?></p>
                  <h3><b>Rp<?=$data[2]?></b></h3>
                  <a href="../transaksi/transaksi.php?id=<?=$tampil?>" class="btn btn-outline-dark btn-secondary">Pilih obat</a>
                  </div>
                </div>
              </div> -->
              ...
              <footer>
                <p>&copy; 2023 A Hak Cipta Dilindungi.</p>
              </footer>
    </head>
</html>