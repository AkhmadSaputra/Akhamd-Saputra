      ...
      <nav class="navbar navbar-expand-lg bg-black m-3" style="border-radius:5px;">
            <div class="container-fluid">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active text-light" aria-current="page" href="../home/home.php">Home</a>
                  </li>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" id="simpan" class="btn btn-primary"><a href="../home/home.php" style="text-decoration:none; color:aliceblue" >Simpan</a></button>
                  </div>
                </div>
              </div>
            </div>
